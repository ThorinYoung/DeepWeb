...
class VidStab:
    ...
    def _apply_transforms(self, output_path, max_frames, use_stored_transforms,
                          ...
                          layer_func=None, playback=False, progress_bar=None, output_fps=None, mybar=None, mytime=None, mypic=None):
        ...
        while True:
            ...
            mybar.setValue(progress_bar.progress * 100)
            mytime.setText("{:.2%}".format(progress_bar.progress))
    ...
    def stabilize(self, input_path, output_path, smoothing_window=30, max_frames=float('inf'),
                  ...
                  output_fps=None, my_bar=None, my_time=None, my_pic=None):
        ...
        self._apply_transforms(output_path, max_frames, use_stored_transforms=use_stored_transforms,
                               ...
                               output_fourcc=output_fourcc, progress_bar=bar, output_fps=output_fps, mybar=my_bar, mytime=my_time, mypic=my_pic)
